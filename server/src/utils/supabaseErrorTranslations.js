/**
 * Mapowanie błędów Supabase na polskie komunikaty (wersja serwerowa)
 */
export const translateSupabaseError = (errorMessage) => {
  ...
  const errorTranslations = {
    ...
    'Invalid JWT': 'Nieprawidłowy token autoryzacji',
    ...
    'null value in column': 'Brakujące wymagane dane',
    'violates foreign key constraint': 'Błąd integralności danych',
