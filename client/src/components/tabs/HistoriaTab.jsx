...
const HistoriaTab = () => {
  ...
  // Pobierz dokumenty i historię przy montowaniu
  useEffect(() => {
    fetchAll();
    fetchStats();
    loadChatHistory();
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              background: activeView === 'documents' ? 'linear-gradient(135deg, #2c5aa0 0%, #4a7dc9 100%)' : 'transparent',
              color: activeView === 'documents' ? 'white' : '#2c5aa0',
              border: 'none',
              padding: '8px 16px',
              borderRadius: '6px',
              cursor: 'pointer',
          ...
          <button
            ...
            style={{
              background: activeView === 'history' ? 'linear-gradient(135deg, #2c5aa0 0%, #4a7dc9 100%)' : 'transparent',
              color: activeView === 'history' ? 'white' : '#2c5aa0',
              border: 'none',
              padding: '8px 16px',
              borderRadius: '6px',
              cursor: 'pointer',
